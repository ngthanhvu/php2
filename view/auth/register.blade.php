...
@section('content')
    ...
    <form method="POST" class="form-control mt-3 w-50 mx-auto p-3 needs-validation" novalidate>
        <div class="mb-3">
            ...
            <input type="text" class="form-control {{ isset($errors['username']) ? 'is-invalid' : '' }}" id="name"
                name="username" placeholder="Nhập tên đăng nhập" required>
            <div class="invalid-feedback">
                {{ isset($errors['username']) ? $errors['username'] : 'Please enter your username.' }}
            </div>
        </div>
        ...
        <div class="mb-3">
            ...
            <div class="invalid-feedback">
                {{ isset($errors['password']) ? $errors['password'] : 'Please enter a password.' }}
            </div>
        </div>
        ...
        <div class="mb-3">
            ...
            <div class="invalid-feedback">
                {{ isset($errors['confirm_password']) ? $errors['confirm_password'] : 'Please confirm your password.' }}
            </div>
        </div>
