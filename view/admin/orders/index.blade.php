            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a href="/admin/orders/delete/<?php echo $order['id']; ?>" class="btn btn-danger btn-sm"><i
                ...
                <div class="modal fade" id="updateStatusModal<?php echo $order['id']; ?>" tabindex="-1"
                    aria-labelledby="updateStatusModalLabel<?php echo $order['id']; ?>" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="updateStatusModalLabel<?php echo $order['id']; ?>">Cập nhật trạng thái
                                    đơn
                                    hàng #<?php echo $order['id']; ?></h5>
                            ...
                            <div class="modal-body">
                                <form action="/admin/orders/update" method="POST">
                                    <div class="mb-3">
                                        <label for="statusSelect<?php echo $order['id']; ?> class="form-label">Chọn trạng thái
                                            mới:</label>
                ...
                <div class="modal fade" id="orderModal<?php echo $order['id']; ?>" tabindex="-1"
                    aria-labelledby="orderModalLabel<?php echo $order['id']; ?>" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="orderModalLabel<?php echo $order['id']; ?>">Chi Tiết Đơn Hàng
