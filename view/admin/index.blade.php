...
@section('content')
        ...
        <div class="row mb-4 mt-3">
            ...
            <div class="col-12 col-md-4 mb-3">
                <div class="card text-white bg-success">
                    <div class="card-body d-flex align-items-center justify-content-between">
                        <div>
                            <h4 class="fw-bold mb-0">{{ number_format($total_revenue, 0, ',', '.') }}đ</h4>
    ...
    <script>
        var months = @json(array_column($monthly_revenue, 'month'));
        var revenueData = @json(array_column($monthly_revenue, 'revenue'));
        var ordersData = @json(array_column($monthly_orders, 'total_orders'));
