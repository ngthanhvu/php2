        ...
        <div class="row mt-4">
            ...
            <div class="col-12 col-md-6 mb-3">
                ...
                <div id="bestSellingCarousel" class="carousel slide" data-bs-ride="carousel">
                    <div class="carousel-inner">
                        ...
                        <div class="carousel-item active">
                            <div class="row">
                                <div class="col-12 col-sm-6 mb-3">
                                    <div class="card">
                                        <img src="https://placehold.co/150x150.png?text=Product+A" class="card-img-top"
                                            alt="Product A">
                                        <div class="card-body">
                                ...
                                <div class="col-12 col-sm-6 mb-3">
                                    <div class="card">
                                        <img src="https://placehold.co/150x150.png?text=Product+B" class="card-img-top"
                                            alt="Product B">
                                        <div class="card-body">
                        ...
                        <div class="carousel-item">
                            <div class="row">
                                <div class="col-12 col-sm-6 mb-3">
                                    <div class="card">
                                        <img src="https://placehold.co/150x150.png?text=Product+C" class="card-img-top"
                                            alt="Product C">
                                        <div class="card-body">
                                ...
                                <div class="col-12 col-sm-6 mb-3">
                                    <div class="card">
                                        <img src="https://placehold.co/150x150.png?text=Product+D" class="card-img-top"
                                            alt="Product D">
                                        <div class="card-body">
                    ...
                    <button class="carousel-control-prev" type="button" data-bs-target="#bestSellingCarousel"
                        data-bs-slide="prev">
                        <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                        <span class="visually-hidden">Previous</span>
                    </button>
                    <button class="carousel-control-next" type="button" data-bs-target="#bestSellingCarousel"
                        data-bs-slide="next">
            ...
            <div class="col-12 col-md-6 mb-3">
                ...
                <div id="slowSellingCarousel" class="carousel slide" data-bs-ride="carousel">
                    <div class="carousel-inner">
                        ...
                        <div class="carousel-item active">
                            <div class="row">
                                <div class="col-12 col-sm-6 mb-3">
                                    <div class="card">
                                        <img src="https://placehold.co/150x150.png?text=Product+E" class="card-img-top"
                                            alt="Product E">
                                        <div class="card-body">
                                ...
                                <div class="col-12 col-sm-6 mb-3">
                                    <div class="card">
                                        <img src="https://placehold.co/150x150.png?text=Product+F" class="card-img-top"
                                            alt="Product F">
                                        <div class="card-body">
                        ...
                        <div class="carousel-item">
                            <div class="row">
                                <div class="col-12 col-sm-6 mb-3">
                                    <div class="card">
                                        <img src="https://placehold.co/150x150.png?text=Product+G" class="card-img-top"
                                            alt="Product G">
                                        <div class="card-body">
                                ...
                                <div class="col-12 col-sm-6 mb-3">
                                    <div class="card">
                                        <img src="https://placehold.co/150x150.png?text=Product+H" class="card-img-top"
                                            alt="Product H">
                                        <div class="card-body">
                    ...
                    <button class="carousel-control-prev" type="button" data-bs-target="#slowSellingCarousel"
                        data-bs-slide="prev">
                        <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                        <span class="visually-hidden">Previous</span>
                    </button>
                    <button class="carousel-control-next" type="button" data-bs-target="#slowSellingCarousel"
                        data-bs-slide="next">
                        <span class="carousel-control-next-icon" aria-hidden="true"></span>
                        <span class="visually-hidden">Next</span>
                    </button>
